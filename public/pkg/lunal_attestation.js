 ...
 * @param {string} compressed_evidence
 * @param {boolean | null} [check_custom_data]
 * @returns {Promise<any>}
 */
export function verify_attestation_evidence(custom_data, compressed_evidence, check_custom_data) {
    const ptr0 = passStringToWasm0(custom_data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(compressed_evidence, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.verify_attestation_evidence(ptr0, len0, ptr1, len1, isLikeNone(check_custom_data) ? 0xFFFFFF : check_custom_data ? 1 : 0);
    return ret;
}

function __wbg_adapter_26(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__ha969125ccd2d7761(arg0, arg1);
}
...
export class VerificationResult {
     ...
     */
    get success() {
        const ret = wasm.verificationresult_success(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {string}
    ...
    get message() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.verificationresult_message(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    get report() {
        const ret = wasm.verificationresult_report(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
     ...
     */
    get certs() {
        const ret = wasm.verificationresult_certs(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     */
    get report_data() {
        const ret = wasm.verificationresult_report_data(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper743 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 280, __wbg_adapter_29);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('lunal_attestation_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
